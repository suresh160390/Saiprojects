...
def eligibility():        
        ...
        def Alert():
            ...
            while counter < 15:
              ...
              # xpath='/html/body/div[7]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div'
        ...
        while counter < 20:
            try:   
                ...
                try:
                    xpath= "/html/body/div[7]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]"
                    WebDriverWait(driver, 0).until(EC.element_to_be_clickable((By.XPATH,xpath))).click()
                    break
                except Exception as e:
                    time.sleep(1)
        ...
        # status="Login Button Not Found"
        # click(xpath,heding,status)
            #   /html/body/div[7]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div
              # /html/body/div[7]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/nav/div/div/a[1]
              
              #xpath= '/html/body/div[7]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/nav/div/div/a[2]'
        # xpath= "/html/body/div[7]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/nav/div/div/a"
        heding="Login Count"
        status="Login Count Field Not Found"        
        # count(xpath,heding,status)
        ...
        while counter < 15:
            try:    
                xpath= "/html/body/div[7]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/nav/div/div/a"         
                rows7=len(WebDriverWait(driver, 0).until(EC.presence_of_all_elements_located((By.XPATH,xpath))))                    
                break
            except Exception as e:
                try:
                    xpath= '/html/body/div[7]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/nav/div/div/a'
                    rows7=len(WebDriverWait(driver, 0).until(EC.presence_of_all_elements_located((By.XPATH,xpath))))                    
                    break
                except Exception as e:
                    time.sleep(1)
        ...
        driver.switch_to.window(driver.window_handles[1])        
              ...
              # /html/body/main/section/div/div/div/form/div[1]/div/div[1]/div/input
        xpath= '/html/body/main/section/div/div/div/form/div[1]/div/div[1]/div/input'
        heding="User Name"
        status="User Name Field Not Found"
        key=user_name
        text_box(xpath,heding,status,key)
        
              # /html/body/main/section/div/div/div/form/div[1]/div/div[2]/div/input
        xpath= '/html/body/main/section/div/div/div/form/div[1]/div/div[2]/div/input'
        heding="Password"
        status="Password Field Not Found"
        key=password
        text_box(xpath,heding,status,key)
        ...
        xpath= "/html/body/main/section/div/div/div/form/div[2]/button"
        heding="Continue"
        status="Continue Button Not Found"
        click(xpath,heding,status)
        
        while True:
                 # /html/body/main/section/div/div/div/form/div[1]/div/div[2]/span
            xpath='/html/body/main/section/div/div/div/form/div[1]/div/div[2]/span'         
            try:
                element_3 = WebDriverWait(driver, 3).until(EC.visibility_of_element_located((By.XPATH, xpath))).text
                if element_3.lstrip().rstrip()=='Wrong username or password':                               
                    messagebox.showinfo('Login Status','Please Check - UserName or Password Wrong')                    
        ...
        for index, row in file.iterrows():                      
            ...
            xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-eligibility-form/div/div/form/div[1]/div[2]/div/claim-autocomplete/div/div/mat-form-field/div/div[1]/div"
            heding="Search"
            ...
            # key=py_nm
            # text_box(xpath,heding,status,key)
                  # /html/body/div[2]/div/div/div/mat-option[2]
            xpath= "/html/body/div[2]/div/div/div/mat-option"
            heding="Payer Count"
            ...
            if cnm.lstrip().rstrip()==py_nm.lstrip().rstrip():
                ...
                xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-eligibility-form/div/div/form/div[2]/oa-provider-search/div/div"
                heding="Provider"
                status="Provider Not Found"
                click(xpath,heding,status)                                
                # /html/body/app-root/app-load-eligibility-provider/oa-modal/div/div/div/div/div[2]/section/div[1]/search-input/div/div/mat-form-field/div/div[1]/div[2]/input
                xpath="/html/body/app-root/app-load-eligibility-provider/oa-modal/div/div/div/div/div[2]/section/div[1]/search-input/div/div/mat-form-field/div/div[1]/div[2]/input"
                heding="NPI"
                ...
                try:
                    xpath= "/html/body/app-root/app-load-eligibility-provider/oa-modal/div/div/div/div/div[2]/section/div[2]/ag-grid-angular/div/div[2]/div[2]/div[3]/div[2]/div/div/div"
                ...
                if rows2 !=0:
                    ...
                    j=1
                    while j<rows2+1:                             
                        xpath= "/html/body/app-root/app-load-eligibility-provider/oa-modal/div/div/div/div/div[2]/section/div[2]/ag-grid-angular/div/div[2]/div[2]/div[3]/div[2]/div/div/div[{}]/div[2]"                                
                        cnm=WebDriverWait(driver, 0).until(EC.visibility_of_element_located((By.XPATH,xpath.format(j)))).text              
                        if cnm==npi:
                            xpath= "/html/body/app-root/app-load-eligibility-provider/oa-modal/div/div/div/div/div[2]/section/div[2]/ag-grid-angular/div/div[2]/div[2]/div[3]/div[2]/div/div/div[{}]"
                            WebDriverWait(driver, 0).until(EC.element_to_be_clickable((By.XPATH,xpath.format(j)))).click()                                          
                    ...
                    xpath= '/html/body/app-root/div[1]/oa-layout/section/section/main/oa-eligibility-form/div/div/form/div[3]/div[2]/claim-input[1]/div/div/mat-form-field/div/div[1]/div[2]/input'
                    heding="First Name"
                    status="First Name Field Not Found"
                    key=py_fnm
                    text_box(xpath,heding,status,key)
                    
                    xpath= '/html/body/app-root/div[1]/oa-layout/section/section/main/oa-eligibility-form/div/div/form/div[3]/div[2]/claim-input[2]/div/div/mat-form-field/div/div[1]/div[2]/input'
                    heding="Last Name"
                    status="Last Name Field Not Found"
                    key=py_lnm
                    text_box(xpath,heding,status,key)
                    ...
                    xpath= '/html/body/app-root/div[1]/oa-layout/section/section/main/oa-eligibility-form/div/div/form/div[3]/div[3]/claim-input[1]/div/div/mat-form-field/div/div[1]/div[2]/input'
                    heding="Date of Birth"
                    status="Date of Birth Field Not Found"
                    key=dob2
                    text_box(xpath,heding,status,key)

                    xpath= '/html/body/app-root/div[1]/oa-layout/section/section/main/oa-eligibility-form/div/div/form/div[3]/div[3]/claim-input[2]/div/div/mat-form-field/div/div[1]/div[2]/input'
                    heding="Member ID"
                    ...
                    xpath= '/html/body/app-root/div[1]/oa-layout/section/section/main/oa-eligibility-form/div/div/form/div[5]/div[2]/oa-datepicker[1]/div/mat-form-field/div/div[1]/div[1]/input'
                    heding="From Date"
                    ...
                    xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-eligibility-form/div/div/div/button"
                    heding="Submit"
                    ...
                    while counter < 60:
                        try:                                                                                                                                     
                            element_4=WebDriverWait(driver, 0).until(EC.visibility_of_element_located((By.XPATH,'/html/body/div[2]/div[2]/div/mat-dialog-container/oa-progress-spinner-dialog')))                                                                   
                            if element_4:                                                                      
                                time.sleep(1)
                                counter += 1
                        except Exception as e:
                    ...
                    while True:
                        try:
                            element_1 = WebDriverWait(driver, 3).until(EC.visibility_of_element_located((By.XPATH, '/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-payer-coverage/div/div/div[2]'))).text
                            break
                        except Exception as e:
                            pass
                    ...
                    if element_1=='Active Coverage':
                        ...
                        xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-summary/div/div[2]/div/div"
                        ...
                        j=1
                        while j<rows+1:                    
                            xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-summary/div/div[2]/div/div[{}]/div[1]"                                
                            cnm=WebDriverWait(driver, 0).until(EC.visibility_of_element_located((By.XPATH,xpath.format(j)))).text              
                            if 'Group Number' in cnm:
                                xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-summary/div/div[2]/div/div[{}]/div[2]"
                        ...
                        if lt==0:                           
                            ...
                            lst.append(vr)
                              ...
                              # /html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[1]/div/button[1]
                        try:
                            xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[2]/div/div[1]/div[1]/h3"
                            # heding="Plan Details"
                            ...
                            while counter < 5:
                                try:             
                                    rows5=len(WebDriverWait(driver, 0).until(EC.presence_of_all_elements_located((By.XPATH,xpath))))                    
                                    break
                                except Exception as e:
                                    time.sleep(1)
                                    counter += 1
                        ...
                        try:            
                            ...
                            try:           
                                xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[1]/div/button" 
                                rows3=len(WebDriverWait(driver, 0).until(EC.presence_of_all_elements_located((By.XPATH,xpath))))                                                                
                            except Exception as e:
                                xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[2]/div/div" 
                                rows3=len(WebDriverWait(driver, 0).until(EC.presence_of_all_elements_located((By.XPATH,xpath))))
                            ...
                            while j<rows3+1:                                                   
                                xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[1]/div/button[{}]"                                
                                cnm=WebDriverWait(driver, 0).until(EC.visibility_of_element_located((By.XPATH,xpath.format(j)))).text                                              
                                if cnm.lstrip().rstrip()=='Other or Additional Payor':                            
                                    xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[1]/div/button[{}]"
                                    WebDriverWait(driver, 0).until(EC.element_to_be_clickable((By.XPATH,xpath.format(j)))).click()
                                                                             
                                    xpath='/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[2]/div/div/div[3]/div[2]/div/div/oa-result-child'
                                    ...
                                    i=1
                                    while i<rows1+1:                                   
                                        xpath='/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[2]/div/div/div[3]/div[2]/div/div/oa-result-child[{}]/div/span[1]'
                                        pn1=WebDriverWait(driver, 0).until(EC.visibility_of_element_located((By.XPATH,xpath.format(i)))).text                                             
                                        if pn1.lstrip().rstrip()=='Plan Name':
                                            xpath='/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[2]/div/div/div[3]/div[2]/div/div/oa-result-child[{}]/div/span[2]'
                                            pn=WebDriverWait(driver, 0).until(EC.visibility_of_element_located((By.XPATH,xpath.format(i)))).text  
                        ...
                        try:                             
                            xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[2]/div/div"                            
                            rows4=len(WebDriverWait(driver, 0).until(EC.presence_of_all_elements_located((By.XPATH,xpath))))  

                            flag=False                             
                            j=1
                            while j<rows4+1:                                        
                                xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[2]/div/div[{}]/div[1]/h3[1]"
                                cnm=WebDriverWait(driver, 0).until(EC.visibility_of_element_located((By.XPATH,xpath.format(j)))).text     
                                if 'Medicare Part B' in cnm:                                            
                                    xpath='/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[2]/div/div[{}]/div[3]/div[2]/div/div/oa-result-child'
                                    rows1=len(WebDriverWait(driver, 0).until(EC.presence_of_all_elements_located((By.XPATH,xpath.format(j)))))  
                                    
                                    i=1
                                    while i<rows1+1:
                                        xpath=' /html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[2]/div/div[{}]/div[3]/div[2]/div/div/oa-result-child[{}]/div/span[1]'
                                        mbi1=WebDriverWait(driver, 0).until(EC.visibility_of_element_located((By.XPATH,xpath.format(j,i)))).text  
                                        if mbi1.lstrip().rstrip()=='Medicare Beneficiary ID (MBI)':                                    
                                            xpath='/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-result-plan/div/div[2]/div/div[{}]/div[3]/div[2]/div/div/oa-result-child[{}]/div/span[2]'
                                            mbi=WebDriverWait(driver, 0).until(EC.visibility_of_element_located((By.XPATH,xpath.format(j,i)))).text  
                                            if mbi==' ':
                                                mbi='N/A' 
                                                lst9.append(mbi)
                                            else:
                        ...
                        xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-transaction-response-nav/div/div/div/div/button"
                        heding="New Search"
                        status="New Search Not Found"
                        click(xpath,heding,status)
                        
                        xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-results/oa-transaction-response-nav/div/div/div/div/div/div[1]/button"
                    ...
                    for cell in reversed(column_cells):
                        if cell.value:
                            last_row = cell.row
                            break                            
                    sheet['T' + str(int(last_row + 1))]='NPI Not Found'       
                    wb1.save(fil)
                    wb1.close()    
                                        
                    xpath= "/html/body/app-root/app-load-eligibility-provider/oa-modal/div/div/div/div/div[3]/button[1]"
                    heding="NPI Cancel Button"
                    status="NPI Cancel Button Not Found"
                    click(xpath,heding,status)

                    xpath= "/html/body/app-root/div[1]/oa-layout/section/header/oa-navigation/div/div[1]/oa-breadcrumbs/nav/ol/li[1]/a"
                    heding="Dashboard Button"
                    status="Dashboard Button Not Found"
                    click(xpath,heding,status)
                                    
                    xpath= "/html/body/app-root/div[1]/oa-layout/section/section/main/oa-dashboard/oa-dashboards-actions/div/div/div[2]/div[1]/button[1]"
                    heding="Verify Eligibility & Benefits Return Button"
                    status="Verify Eligibility & Benefits Return Button Not Found"
                    click(xpath,heding,status)
            else:
                wb1=load_workbook(filename=fil)
                sheet = wb1['Eligibility BOT']
                ...
                for cell in reversed(column_cells):
                    if cell.value:
                        last_row = cell.row
                        break                            
                sheet['T' + str(int(last_row + 1))]='Payer Name Not Found'       
                wb1.save(fil)
                wb1.close()    
